...
![SLAM Splunk Dashboard](screenshots/img.png)

### 🔍 SPL Detection

![SLAM SPL Detection](screenshots/img_1.png)
---
...
Web-інтерфейс Splunk буде доступний за адресою: `http://localhost:8000`
...
Використайте: `/var/log/nginx_logs`

### Крок 3 — Sourcetype

На етапі Set Sourcetype створіть новий тип: `access_combined`

### Крок 4 — Index

У Input Settings створіть або виберіть індекс: `web_logs`
